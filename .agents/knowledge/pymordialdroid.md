...
> [!NOTE]
> This technical guide documents the host-side infrastructure, wireless ADB networking, `scrcpy` display streaming, and the `PymordialDroid` Fleet Commander automation stack located in `D:\projects\PymordialDroid`.
